...
public class PostRandomUserNoValid implements Task {

    private static final Logger LOGGER = LoggerFactory.getLogger(PostRandomUserNoValid.class);
    ...
    public static PostRandomUserNoValid conDatosAleatorios() {
        return instrumented(PostRandomUserNoValid.class);
    }
